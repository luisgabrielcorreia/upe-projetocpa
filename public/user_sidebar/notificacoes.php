...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <a href="notificacoes.php" class="active"><i class="bi bi-bell"></i> <span>Notificacoes</span></a>
    ...
    <div class="container mt-5">
        ...
        <div id="notification-list" class="list-group mt-4">
            <a href="#" class="list-group-item list-group-item-action">Você não tem novas notificações.</a>
        </div>
    </div>
</div>
    </div>
